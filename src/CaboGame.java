  ...
  public void deckCheck() {
    ...
    for (BaseCard card : check) {
    	if(card instanceof ActionCard) {
    		if(((ActionCard) card).getActionType().equals("peek")) { peek++; }
    		else if(((ActionCard) card).getActionType().equals("spy")) { spy++; }
    		else if(((ActionCard) card).getActionType().equals("switch")) { swi++; }
    	}
    }
